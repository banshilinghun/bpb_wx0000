  ...
  onLoad: function (options) {
    ...
    if(flag == 1){
      ...
      list = [{ cellTitle: '如何注册加入奔跑宝？', path: url, content: '打开微信搜索【奔跑宝】小程序或者关注【奔跑宝】微信公众号，使用手机号进行注册。' }, 
        ...
        { cellTitle: '广告如何计费？', path: url, content: '奔跑宝小程序根据广告时间以固定价格的计算方式给到车主（特殊情况除外）。', flag: 'valuation'}, 
        { cellTitle: '广告损坏如何处理？', path: url, content: '如果广告中途损坏请第一时间联系奔跑宝客服，奔跑宝会安排工作人员进行对接。广告结束后检测时出现损坏奔跑宝会根据规则扣除相应费用，广告每缺少一个门扣除广告总收益的25。' }, 
      ...
      list = [{ cellTitle: '广告贴是否会伤害车辆漆面？', path: url, content: '您好，奔跑宝车身广告材料使用的是美国“艾利丹尼森”户外写真背胶，不掉漆、不留胶。只要您粘贴广告的车辆是原厂车漆，广告粘贴位置无刮痕，车贴不会对车漆造成伤害。 \n广告检测在服务网点工作人员撕掉时，清除车身广告如造成对车漆（此车漆为原车漆）伤害，车漆维修费用由奔跑宝负责。 \n如车主车辆非原车车漆，撕掉车身广告带来的车漆损伤，双方另行协商解决。 \n如车辆漆面本身有破损，车主仍参加车身广告活动，一切损失与奔跑宝无关。' }, 

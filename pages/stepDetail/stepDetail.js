...
Page({
  ...
  data: {
    ...
    stepArray: [{
      title: '预约',
      content: '在广告市场领取广告任务，就近选择服务网点并预约安装时间'
    }, {
      title: '签到',
      content: '需要您在预约时间内导航前往服务网点，并在程序内签到'
    }, {
      title: '安装',
      content: '网点工作人员免费安装广告'
    }, {
      title: '激活',
      content: '需要您在程序内拍摄广告照片并上传，后台审核后激活广告'
    }, {
      title: '奔跑',
      content: '广告激活后正常跑车接单，中途如有疑问请及时联系【奔跑宝】客服'
    }]
  },
    ...
    let requestData = {
      ...
      success: res => {
        ...
        if (parseInt(res.user_type) === 1) { //是否是滴滴合法车主
          stepArray.push({
            title: '检测',
            content: '广告任务结束后，需要您在程序内拍摄广告照片并上传，审核通过后即可在【滴滴】车主端内提现广告收益'
          })
        } else {
          stepArray.push({
            title: '检测',
            content: '广告任务结束后，需要您在程序内拍摄广告照片并上传，审核通过后即可提现广告收益'
          })
        }
        that.setData({
          stepArray: stepArray
